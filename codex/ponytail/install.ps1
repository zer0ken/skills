#!/usr/bin/env pwsh
# Install or update the `ponytail` skill into the personal codex skills dir.
# Re-running this fetches the latest version (install and update are identical).
$ErrorActionPreference = 'Stop'

$dest = Join-Path $env:USERPROFILE '.codex\skills\ponytail'
$src  = 'https://raw.githubusercontent.com/zer0ken/skills/main/codex/ponytail/SKILL.md'
