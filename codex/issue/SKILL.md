...
```powershell
irm https://raw.githubusercontent.com/zer0ken/skills/main/codex/issue/install.ps1 | iex
```

Bash (macOS / Linux / WSL):

```bash
curl -fsSL https://raw.githubusercontent.com/zer0ken/skills/main/codex/issue/install.sh | bash
```
