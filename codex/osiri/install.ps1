#!/usr/bin/env pwsh
# Install or update the `osiri` skill into the personal codex skills dir.
# Re-running this fetches the latest version (install and update are identical).
$ErrorActionPreference = 'Stop'

$dest = Join-Path $env:USERPROFILE '.codex\skills\osiri'
$src  = 'https://raw.githubusercontent.com/zer0ken/skills/main/codex/osiri/SKILL.md'
