...
$dest = Join-Path $env:USERPROFILE '.claude\skills\openai-cookbook'
...
Write-Host "openai-cookbook skill installed/updated at $dest"
Write-Host "Restart Claude Code (or open a new session) to pick it up, then run /openai-cookbook"
