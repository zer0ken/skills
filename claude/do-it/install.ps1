#!/usr/bin/env pwsh
# Install or update the `do-it` skill into the personal Claude Code skills dir.
# Re-running this fetches the latest version (install and update are identical).
$ErrorActionPreference = 'Stop'
$dest = Join-Path $HOME '.claude/skills/do-it'
$base = 'https://raw.githubusercontent.com/zer0ken/skills/main/claude/do-it'
...
Write-Host "Restart Claude Code (or open a new session) to pick it up, then invoke the do-it skill"
